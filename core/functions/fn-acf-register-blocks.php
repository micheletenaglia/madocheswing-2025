...
class mktBlocks{
    ...
    public function __construct() {
        ...
        // Set allowed blocks
        add_filter('allowed_block_types_all',[$this,'allowed_block_types_all'],10,1);

        // Enqueue custom blocks scripts
        add_action('enqueue_block_editor_assets',[$this,'enqueue_block_editor_assets'],PHP_INT_MAX);
     ...
     * Register core blocks.
     */
    public function core_acf_blocks_init() : void {
